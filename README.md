...
Zero-standing-privilege automation suite built across CrowdStrike, FortiOS, JumpServer, Teleport, and OPA.

### Live Contributions
| Tool           | Feature                            | PR / Status |
|----------------|------------------------------------|-------------|
...
https://github.com/Manjula101/phd-cyber-lab
